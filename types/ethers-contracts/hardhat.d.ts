...
getContractFactory(name: 'SafePot', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SafePot__factory>

  getContractAt(name: 'IERC20', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.IERC20>
getContractAt(name: 'SafePot', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SafePot>

  deployContract(name: 'IERC20', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.IERC20>
deployContract(name: 'SafePot', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SafePot>

  deployContract(name: 'IERC20', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.IERC20>
deployContract(name: 'SafePot', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SafePot>
